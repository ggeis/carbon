...
### With the transparent effect
if you want to create a transparent effect to header you have to override header background styling
to match the same color as a background

<Preview>
  <Story name="with a transparent effect" parameters={{ info: { disable: true }}} >
    <div style={{background: '#FF785B', padding: '10px'}}>
      <FlatTable styleOverride={{headerBackground: '#FF785B'}}>
        <FlatTableHead>
          <FlatTableRow>
            <FlatTableHeader>Client</FlatTableHeader>
            <FlatTableHeader>Client Type</FlatTableHeader>
